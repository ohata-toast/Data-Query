...
### 2026. 03. 24.
#### 기능 개선/변경
* 콘솔 쿼리 결과 표시 정책을 개선하였습니다.
  * 콘솔에서 실행한 쿼리의 결과를 1MB, 5,000행 이내에서 표시하는 제한을 제거하였습니다.
  * 콘솔에서 실행한 쿼리의 결과를 최대 30MB까지 표시할 수 있도록 개선하였습니다.
  * 콘솔 쿼리 결과 조회와 복사를 위한 버튼을 추가하였습니다.

### 2025. 09. 23.
#### Trino 버전 업그레이드
* DataQuery를 Trino 476 버전을 기반으로 서비스하도록 업그레이드하였습니다.
