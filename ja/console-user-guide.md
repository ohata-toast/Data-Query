...
<img src="https://static.toastoven.net/prod_dataquery/console-user-guide/2026-03/ko/dataquery_console_01.png" alt="クエリエディタ画面"/>
...
<img src="https://static.toastoven.net/prod_dataquery/console-user-guide/2025-09/ko/dataquery_console_02.png" alt="クエリ履歴画面"/>
...
<img src="https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_2acdfabf4efe4efc8a04c00b348110c9/cdn_origin/prod_dataquery/dataquery_console_03_ko.png" alt="クエリ履歴画面"/>
...
* 制約事項
    * DELETE, UPDATEは特定の条件が満たされる場合のみ制限的に実行できます。
        * where句が存在する時、術語(Predicate)がデータソースに完全にプッシュダウン(Pushdown)できる必要があります。
        * CLOB, NCLOB, BLOB, or RAW(n)であるOracleタイプのカラムはプッシュダウンがサポートされません。
