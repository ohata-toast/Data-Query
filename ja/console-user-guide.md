...
* 制約事項
    ...
    * UPDATEは、特定の条件が満たされる場合のみ制限的に実行できます。
        ...
        * 算術式、関数呼び出しおよび定数以外の値へのUPDATE文はサポートされません。
        * テーブルのすべての列を同時に更新することはできません。
        * [詳細情報](https://trino.io/docs/476/connector/postgresql.html#update)
...
* 制約事項
    ...
    * UPDATEは、特定の条件が満たされる場合のみ制限的に実行できます。
        ...
        * 算術式、関数呼び出しおよび定数以外の値へのUPDATE文はサポートされません。
        * テーブルのすべての列を同時に更新することはできません。
        * [詳細情報](https://trino.io/docs/476/connector/oracle.html#update)
...
* 制約事項
    ...
    * UPDATEは、特定の条件が満たされた場合のみ制限的に実行できます。
        ...
        * 算術式、関数呼び出しおよび定数以外の値へのUPDATE文はサポートされません。
        * テーブルのすべての列を同時に更新することはできません。
        * [詳細情報](https://trino.io/docs/476/connector/mariadb.html#update)
